...
<https://forms.gle/jcoP8kd3My31x3Gu6>`;
    ...
    // Mute 12 hours
    dmMsg = `You have been temporarily muted for 12 hours in the Modtv1337 server for the following reason:
**${reason}**
You were given **${newPoints} bee sting${newPoints === 1 ? '' : 's'}** and your total is **${newPoints + curPoints}**.
If you wish to contact the moderators about your mute, please use the \`.modmail <message>\` command in this DM.`;
    ...
    // Mute 1 hour
    dmMsg = `You have been temporarily muted for 1 hour in the Modtv1337 server for the following reason:
**${reason}**
You were given **${newPoints} bee sting${newPoints === 1 ? '' : 's'}** and your total is **${newPoints + curPoints}**.
If you wish to contact the moderators about your mute, please use the \`.modmail <message>\` command in this DM.`;
    action = '1 Hour Mute';
    ...
    // Mute 30 minutes
    dmMsg = `You have been temporarily muted for 30 minutes in the Modtv1337 server for the following reason:
**${reason}**
You were given **${newPoints} bee sting${newPoints === 1 ? '' : 's'}** and your total is **${newPoints + curPoints}**.
If you wish to contact the moderators about your mute, please use the \`.modmail <message>\` command in this DM.`;
    ...
    // Mute 10 minutes
    dmMsg = `You have been temporarily muted for 10 minutes in the Modtv1337 server for the following reason:
**${reason}**
You were given **${newPoints} bee sting${newPoints === 1 ? '' : 's'}** and your total is **${newPoints + curPoints}**.
If you wish to contact the moderators about your mute, please use the \`.modmail <message>\` command in this DM.`;
    ...
    // Give warning
    dmMsg = `You have been warned in the Modtv1337 server for the following reason:
**${reason}**
You were given **${newPoints} bee sting${newPoints === 1 ? '' : 's'}** and your total is **${newPoints + curPoints}**.
